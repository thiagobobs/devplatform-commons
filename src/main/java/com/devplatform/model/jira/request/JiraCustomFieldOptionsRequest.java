...
public class JiraCustomFieldOptionsRequest {
	@JsonProperty("options")
	private List<JiraCustomFieldOption> options = null;

	public JiraCustomFieldOptionsRequest(JiraCustomFieldOption option) {
		super();
		if(option != null) {
	...
	public JiraCustomFieldOptionsRequest(List<JiraCustomFieldOption> options) {
		super();
		this.options = options;
	}

	public JiraCustomFieldOptionsRequest options(List<JiraCustomFieldOption> options) {
		this.options = options;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		JiraCustomFieldOptionsRequest jiraIssue = (JiraCustomFieldOptionsRequest) o;
