...
public class JiraCustomFieldOptionRequest {
	...
	public JiraCustomFieldOptionRequest id(BigDecimal id) {
		this.id = id;
		return this;
	}
	...
	public JiraCustomFieldOptionRequest self(String self) {
		this.self = self;
		return this;
	}
	...
	public JiraCustomFieldOptionRequest sequence(Integer sequence) {
	...
	public JiraCustomFieldOptionRequest value(String value) {
		this.value = value;
		return this;
	}
	...
	public JiraCustomFieldOptionRequest enabled(Boolean enabled) {
	...
	public JiraCustomFieldOptionRequest cascadingOptions(List<String> cascadingOptions) {
